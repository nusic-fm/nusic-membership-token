...
async function main() {
  ...
  const txt = await nusicAliveCollectivePass.transferOwnership("0xA0cb079D354b66188f533A919d1c58cd67aFe398")
  console.log("nusicAliveCollectivePass.transferOwnership txt.hash = ",txt.hash);
